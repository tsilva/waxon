...
- Capture screenshots under `/private/tmp` with names that include the suite or state, for example `/private/tmp/waxon-signed-in-question-bank.png`.
...
- The Question Bank should be visible locally for the test user.

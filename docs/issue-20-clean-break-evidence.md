...
| --- | --- | --- |
| 1. Isolated identity/private Question Bank/initial obsolete-control sweep | passed | Dedicated acceptance Learner opened an empty private bank; Active, Flagged, and Archived were the only lifecycle filters; obsolete source, generation, concept, capacity, retention, Pause, and Trash controls were absent. |
...
| 8. Desktop/narrow responsive and obsolete-control sweep | passed | Question Bank and Review were visually inspected at desktop and 390 x 844; long content, grade controls, the modal, and all bank states remained contained with no clipping or overlapping actions; the obsolete-control sweep remained clean. |

...
resource: AGENTS.md
tags: [product, learning, review, knowledge-base]
...
Waxon is an app for learning any topic through adaptive question-and-answer practice. A user states learning goals through courses or generated question prompts, and the app expands those goals into targeted questions that match the user's current knowledge while gradually covering the full topic.
...
* The user's knowledge base is the durable question scope.
...
* For question work, use the shared quality reference at `reference/question-quality.md`.

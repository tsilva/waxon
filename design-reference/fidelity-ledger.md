...
- June 13, 2026 Learn update: selected-course chat now stretches to the full shell height, the answer composer sits near the lower edge of the workspace, and the course grid is constrained on mobile so the horizontal topic rail scrolls inside the viewport instead of widening the page.

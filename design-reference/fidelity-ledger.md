...
- Issue #20 native case 5 exposed an overlapping desktop Easy control; the normal-flow layout fix has a deterministic regression and awaits the coordinator's complete fresh native rerun before fidelity is marked verified.
